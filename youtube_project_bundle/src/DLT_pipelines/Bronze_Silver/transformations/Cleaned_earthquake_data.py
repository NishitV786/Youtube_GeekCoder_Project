...
# Create a streaming table from view
dlt.create_streaming_table(name="earthquake_data_final")

# Add only new data no duplicate data needed as we will receive data daily. So we are taking id column as primary key.
# Using SCD type 1 overwrites existing data with new information,
dlt.apply_changes(
